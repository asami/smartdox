...
""".r
  ...
  sealed trait DoxLinesParseState extends LogicalLineReaderWriterState[Config, Dox] with DoxLinesParseStateSupport {
  }

  sealed trait ChildDoxLinesParseState extends DoxLinesParseState with ChildDoxLinesParseStateSupport {
  ...
  case class NormalState(
    lines: Vector[Dox],
    title: Option[Inline]
  ) extends DoxLinesParseState with DoxLinesNormalStateSupport {
